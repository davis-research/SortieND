...
const int MESSAGE_SIZE = 250; /**<Size of message strings.*/
/**This is the structure for sending and receiving messages*/
struct modelMsg {
  int iMessageCode;             /**<Integer message code.  See constants.*/
  char cMoreInfo[MESSAGE_SIZE], /**<String to hold additional information, if
                                needed, according to the message code*/
       cFunction[MESSAGE_SIZE]; /**<Function in which the error occurred -
...
struct modelErr {
  ...
  char cMoreInfo[MESSAGE_SIZE], /**<String to hold additional information, if
       ...
       cFunction[MESSAGE_SIZE]; /**<Fnction in which the error occurred -
                                probably not for user consumption*/
};
