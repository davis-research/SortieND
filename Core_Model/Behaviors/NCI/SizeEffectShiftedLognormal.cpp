...
// CalculateSizeEffect
////////////////////////////////////////////////////////////////////////////
float clSizeEffectShiftedLognormal::CalculateSizeEffect(int iSpecies, float fDiam) {
  float fSizeEffect;
  ...
  fSizeEffect = exp(-0.5 * pow(log((fDiam + mp_fXp[iSpecies]) / mp_fX0[iSpecies] ) / mp_fXb[iSpecies], 2));
